...
const PROGRESSION_BY_TYPE: Record<MechaType, LevelLearnedAttack[]> = {
  fire:      [
    { level: 2,  attackId: 'fire_t1' },
    { level: 4,  attackId: 'ember_punch' },
    { level: 7,  attackId: 'cinder_burst' },
    { level: 12, attackId: 'fire_t4' },
    { level: 20, attackId: 'fire_t5' },
  ],
  water:     [
    { level: 2,  attackId: 'water_t1' },
    { level: 4,  attackId: 'water_jet' },
    { level: 7,  attackId: 'tide_cannon' },
    { level: 12, attackId: 'water_t4' },
    { level: 20, attackId: 'water_t5' },
  ],
  lightning: [
    { level: 2,  attackId: 'lightning_t1' },
    { level: 4,  attackId: 'spark' },
    { level: 7,  attackId: 'thunderfork' },
    { level: 12, attackId: 'lightning_t4' },
    { level: 12, attackId: 'replenish_charge' }, // Lightning-only support move; ally-targeted battery transfer
    { level: 20, attackId: 'lightning_t5' },
  ],
  ice:       [
    { level: 2,  attackId: 'ice_t1' },
    { level: 4,  attackId: 'frost_jab' },
    { level: 7,  attackId: 'frostbite' },
    { level: 12, attackId: 'ice_t4' },
    { level: 20, attackId: 'ice_t5' },
  ],
  earth:     [
    { level: 2,  attackId: 'earth_t1' },
    { level: 4,  attackId: 'stone_fist' },
    { level: 7,  attackId: 'quake_slam' },
    { level: 12, attackId: 'earth_t4' },
    { level: 20, attackId: 'earth_t5' },
  ],
  bio:       [
    { level: 2,  attackId: 'bio_t1' },
    { level: 4,  attackId: 'spore_lash' },
    { level: 7,  attackId: 'rot_touch' },
    { level: 12, attackId: 'bio_t4' },
    { level: 20, attackId: 'bio_t5' },
  ],
  steel:     [
    { level: 2,  attackId: 'steel_t1' },
    { level: 4,  attackId: 'rivet_punch' },
    { level: 7,  attackId: 'piston_slam' },
    { level: 12, attackId: 'steel_t4' },
    { level: 20, attackId: 'steel_t5' },
  ],
  mental:    [
    { level: 2,  attackId: 'mental_t1' },
    { level: 4,  attackId: 'neurospike' },
    { level: 7,  attackId: 'mind_lance' },
    { level: 12, attackId: 'mental_t4' },
    { level: 20, attackId: 'mental_t5' },
  ],
};

/** The default tier-1 attack for each type — kept for reference but moved to LV2 progression. */
...
function mk(
  ...
  return {
    ...
    baseStats: stats,
    maxHp,
    defaultAttacks: opts.defaults ?? ['basic_strike'],
