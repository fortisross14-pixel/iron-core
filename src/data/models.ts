...
export const MODELS: Record<string, ModelData> = {
  ...
  // Not for sale. Unique to the prologue.
  hearthling: {
    ...
    flavor: 'Your uncle built this one for you. He carved your initials into the chest plate.',
  },

  // ============ COMMONS (sold in stores) ============
  scrap_grunt: {
    id: 'scrap_grunt', dexNo: 2, surname: 'ScrapGrunt', type: 'earth',
  ...
  iron_jack: {
    id: 'iron_jack', dexNo: 3, surname: 'IronJack', type: 'steel',
  ...
  shore_drone: {
    id: 'shore_drone', dexNo: 4, surname: 'ShoreDrone', type: 'water',
  ...
  glassthorn: {
    id: 'glassthorn', dexNo: 5, surname: 'Glassthorn', type: 'ice',
  ...
  pollen_one: {
    id: 'pollen_one', dexNo: 6, surname: 'Pollen-One', type: 'bio',
  ...
  voltrunner: {
    id: 'voltrunner', dexNo: 7, surname: 'VoltRunner', type: 'lightning',
  ...
  tidewall: {
    id: 'tidewall', dexNo: 8, surname: 'Tidewall', type: 'water',
  ...
  // ============ UNCOMMONS ============
  cinderboar: {
    id: 'cinderboar', dexNo: 9, surname: 'Cinderboar', type: 'fire',
  ...
  rockwarden: {
    id: 'rockwarden', dexNo: 10, surname: 'Rockwarden', type: 'earth',
  ...
  rust_husk: {
    id: 'rust_husk', dexNo: 11, surname: 'RustHusk', type: 'steel',
  ...
  feral_grub: {
    id: 'feral_grub', dexNo: 12, surname: 'FeralGrub', type: 'bio',
    rarity: 'common', role: 'Abandoned', acquisition: 'Junkyard wild',
  ...
  brittle_charge: {
    id: 'brittle_charge', dexNo: 13, surname: 'BrittleCharge', type: 'lightning',
    rarity: 'common', role: 'Abandoned', acquisition: 'Junkyard wild',
